#!/bin/bash
# Original Author of this Minecraft Server Installation Script - James A. Chambers - https://jamesachambers.com
# Modifications by Scott Aday to include pushing backups to AWS S3
# 
# Instructions: https://jamesachambers.com/minecraft-bedrock-edition-ubuntu-dedicated-server-guide/
# To run the setup script use:
# wget https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/SetupMinecraft.sh
# chmod +x SetupMinecraft.sh
# ./SetupMinecraft.sh
#
# GitHub Repository: https://github.com/ScottAday/MinecraftBedrockServer

echo "Minecraft Bedrock Server installation script by James Chambers - July 24th 2019"
echo "Script modified by Scott Aday - July 6th 2020"
echo "Latest version always at https://github.com/ScottADay/MinecraftBedrockServer"
...
if [ -d "$ServerName" ]; then
  ...
  wget -O start.sh https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/start.sh
  chmod +x start.sh
  ...
  wget -O stop.sh https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/stop.sh
  chmod +x stop.sh
  ...
  wget -O restart.sh https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/restart.sh
  chmod +x restart.sh
  ...
  sudo wget -O /etc/systemd/system/$ServerName.service https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/minecraftbe.service
...
if [[ "$CPUArch" == *"aarch"* || "$CPUArch" == *"arm"* ]]; then
  ...
  wget -O depends.zip https://raw.githubusercontent.com/ScottAday/MinecraftBedrockServer/master/depends.zip
  unzip depends.zip
  sudo mkdir /lib64
